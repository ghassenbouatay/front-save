...
@Component({
  selector: "app-surviver",
  templateUrl: "./surviver.component.html",
  styleUrls: ["./surviver.component.css"],
})
export class SurviverComponent implements OnInit {
  _hotel: any;
  _dataRead: any;
  ...
  addHotel() {
    this.hotelServ.addsaver(this.hotelForm.value).subscribe((res) => {
      console.log(res);
      this.display();
  ...
  updateHotel() {
    this.hotelServ
      .updatesurviver(this.hotelForm.value, this.updateId)
      .subscribe((res) => {
        console.log(res);
        this.display();
